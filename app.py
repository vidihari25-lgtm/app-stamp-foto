...
def add_stamp_to_image(image, text_content):
    ...
    font = None
    # Pastikan file arial.ttf sudah diupload ke GitHub
    font_file = "arial.ttf"
    ...
    try:
        if os.path.exists(font_file):
            ...
            # Jika file arial.ttf tidak ada, coba gunakan arialbd.ttf yang sudah ada
    ...
    # Efek Bayangan (Shadow dibuat lebih halus/soft)
